...
namespace Pokno.Home.ViewModels
{
    public class HomeViewModel : ImageViewModel
    {
       private CryptoLicense _lic;
        private IBusinessFacade _service;
        private IEventAggregator _eventAggregator;

        public HomeViewModel(IBusinessFacade service, IEventAggregator eventAggregator)
        {
            _service = service;
